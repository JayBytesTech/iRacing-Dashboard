import type { FuelEstimate, FuelStatus, FuelConfidence, PlayerCar } from '@/lib/contracts';
...
export function FuelWidget({ player, fuel }: { player: PlayerCar; fuel?: FuelEstimate }) {
  ...
  return (
    <section style={{ background: '#141925', borderRadius: 10, padding: 18 }}>
      ...
      {hasEstimate ? (
        <>
          {/* The number a crew chief actually calls. */}
